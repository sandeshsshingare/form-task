...
checkp.addEventListener("change", function () {
    ...
    if (checkp.checked &&
        ...
        //alert(postal.value);
        //  alert("clicked");
        var m = document.getElementById("address12");
        m.value = address1.value;
        var m1 = document.getElementById("address22");
...
function postverify() {
    ...
    if (post.value.length == 6) {
        document.getElementById("postal").style.border =
            "1px solid green";
        p = true;
    }
    else {
...
function passwordf() {
    ...
    if (passwordvalue.length >= 8 &&
        ...
        document.getElementById("password").style.border =
            " 1px solid green";
        passwordforcheck = document.getElementById("password")
            .value;
    }
    else {
        document.getElementById("password").style.border =
